...
struct ggml_tensor * llama_model_loader::create_tensor(
    ...
    auto ctx_for_buft = [&](ggml_backend_buffer_type_t buft) -> ggml_context * {
        ...
        if (it == ctx_map.end()) {
            ...
            // ponytail: headroom applies always, not just when files.empty().
            // The merged qwen35/MTP loader creates tensors beyond the file count;
            // 256/layer is cheap (~4MB) and the comment above already blesses it.
